 ...
 * Thanks goes to Cal Henderson at iamcal.com for the great php search script example
...
class Search
{
    ...
    */
     ...
     * @param array|string $fields       The fields we're searching in.
    ...
    /**
     * Escapes the string ($string) in-case some of the characters in the search term contain a MySQL regular
     * expression meta-character. Returns the escaped string.
     *
    ...
    protected function prepareWhere($terms, $fields, $branch, $filter)
    {
        ...
        */
        ...
        foreach ($fields as $field) {
            if (($filter === null) || (isset($filter['filter_fields']) && !in_array($field,
