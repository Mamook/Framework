...
class Category
{
     ...
     *
     * @param string $categories              The names and/or id's of the category(ies) to be retrieved - may be
     *                                        multiple categories - separate with a dash, ie. '50-70-Archive-110'. Use
     *                                        a "!" to designate Categories NOT to be returned, ie.
     *                                        '50-!70-Archive-110')
    ...
    /**
     * getThisCategory
     * Retrieves category info from the `categories` table in the Database for the passed id or category name and sets
