...
class Contributor extends User
{
    ...
    /**
     * getContFirstName
     * Returns the data member $cont_fname if the fname data member from the parent User class is NULL, otherwise it
     * returns that.
     *
     * @access    public
     */
    ...
    /**
     * getContLastName
     * Returns the data member $cont_lname if the lname data member from the parent User class is NULL, otherwise it
     * returns that.
     *
     * @access    public
     */
    ...
    /**
     * getContEmail
     * Returns the data member $cont_email if the email data member from the parent User class is NULL, otherwise it
     * returns that.
     *
     * @access    public
     */
    ...
    /**
     * getContRegion
     * Returns the data member $cont_region if the region data member from the parent User class is NULL, otherwise it
     * returns that.
     *
     * @access    public
     */
    ...
    /**
     * getContCountry
     * Returns the data member $cont_country if the country data member from the parent User class is NULL, otherwise
     * it returns that.
     *
     * @access    public
     */
    ...
    /**
     * getContOrganization
     * Returns the data member $cont_organization if the organization data member from the parent User class is NULL,
        ...
        try {
            ...
            if ($contributor === false) {
                ...
                if ($contributor === false) {
                    ...
                    $contributor = $this->getThisContributor(array(
                        'fname' => $this->getFirstName(),
                        'lname' => $this->getLastName()
                    ), 'name', $find);
                }
    ...
    /***
     * displayContributor
     * Retrieves the contributor's information from the database sets to to a display array. This method is designed to
     * feed the displayProfile method of the parent User class.
     *
     * @param    string  $value May be the contributor id, user ID, email, or first and last names (names must be in an
     *                          array).
     ...
     * field and sets it to the data member.
     *
    ...
    /**
     * getContName
     * Joins the Contributor's first and last names to create a full name. If the Display Name data member is set in
     * the parent User class it is set instead.
     *
     * @access    public
     */
    ...
    public function removeUser($user_id)
    {
        ...
        try {
            ...
            throw new Exception('There was an error removing User ID: ' . $user_id . ' from the contributor\'s data: ' . $e->error . '<br />Code: ' . $e->errno . '<br />Last query: ' . $e->last_query,
                E_RECOVERABLE_ERROR);
        } catch (Exception $e) {
            throw $e;
        }
    ...
    public function updateContributor($where_field, $field_value)
    {
        ...
        try {
            ...
            throw new Exception('There was an error updating Contributor\'s info: ' . $ez->error . '<br />Code: ' . $ez->errno . '<br />Last query: ' . $ez->last_query,
                E_RECOVERABLE_ERROR);
        }
    }
    ...
    protected function setContPrivacy($cont_privacy)
    {
        ...
        if ($cont_privacy !== null) {
            ...
            if ($validator->isInt($cont_privacy) === true) {
                ...
                throw new Exception('The passed value for the contributor\'s privacy was not an integer!',
                    E_RECOVERABLE_ERROR);
            }
        }
        # Set the data member.
